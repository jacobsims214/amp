...
type EpicRepository interface {
	...
	SetState(ctx context.Context, epicID int, state string, reason string) error
	Delete(ctx context.Context, epicID int) error
	DeleteByProject(ctx context.Context, projectID int) (int, error)
}
...
type StoryRepository interface {
	...
	SetState(ctx context.Context, storyID int, state string, reason string) error
}
