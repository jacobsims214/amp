...
- `skill("react-engineer")` — React/TypeScript/Vite patterns, Zustand, TanStack Query, Tailwind
- `skill("testing-strategy")` — RTL query priority, MSW v2 handlers
- `skill("ui-ux-pro-max")` — visual/UX design guidance
