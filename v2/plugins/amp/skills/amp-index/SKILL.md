...
Load skills on demand using the **name** skill when you determine they are relevant.
...
These are the agents currently defined under `${CLAUDE_PLUGIN_ROOT}/agents/*.md`. This list is for onboarding
